window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var STYLE_TEXT = [
			...
			".dsh-ms-effortBadge{display:inline-flex;align-items:center;height:18px;padding:0 5px;",
				"border-radius:9px;font-size:10px;font-weight:600;line-height:14px;letter-spacing:0.2px;",
				"background:var(--dsw-alias-interactive-bg-selected);",
				"color:var(--dsw-alias-label-secondary);white-space:nowrap;user-select:none;flex:0 0 auto;}",
			".dsh-ms-effortDot{width:5px;height:5px;border-radius:50%;margin-right:3px;",
		...
		function ModelSearch(props) {
			...
			triggerChildren.push(iconChevron(open));
